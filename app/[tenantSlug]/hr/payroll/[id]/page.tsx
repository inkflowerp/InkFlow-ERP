...
export default function PayrollDetailPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl print:max-w-none print:w-full print:bg-white print:text-slate-900 print:dark:bg-white print:dark:text-slate-900 print:m-0 print:p-0">
