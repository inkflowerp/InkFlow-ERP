...
--   3. Authoritative actor identity enforcement: COALESCE(v_auth_uid, p_actor_user_id)
--   4. Tenant isolation boundary enforcement across all atomic financial mutations
-- ==============================================================================

-- 1. HARDENED ATOMIC RPC: RECORD MULTI-INVOICE PAYMENT ALLOCATION
...
-- 2. HARDENED ATOMIC RPC: RECORD FINANCIAL WRITE-OFF
...
-- 3. HARDENED ATOMIC RPC: CANCEL / VOID INVOICE
...
-- 4. ATOMIC RPC: RECONCILE CUSTOMER BALANCE
...
BEGIN
    ...
    LOOP
        ...
        SET total_invoiced_amount = v_calc_invoiced,
            ...
            updated_at = NOW()
        WHERE id = v_cust.id AND company_id = p_company_id;
