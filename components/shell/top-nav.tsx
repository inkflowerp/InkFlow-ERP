      ...
      <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
        ...
        <div ref={quickActionRef} className="relative shrink-0">
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-blue-600 px-3.5 py-2 text-xs sm:text-sm font-bold text-white hover:bg-blue-700 shadow-sm shadow-blue-500/20 cursor-pointer transition-all active:scale-98 shrink-0 whitespace-nowrap min-h-[40px]"
          ...
          {isQuickActionOpen && (
            <div className="absolute right-0 mt-2 w-64 max-w-[calc(100vw-1.5rem)] rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900 p-2 z-50 animate-in fade-in-0 zoom-in-95">
              <div className="px-2.5 py-1 text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center justify-between">
                ...
                <span className="font-mono text-[10px] bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded-md font-bold">Hotkey: N</span>
              </div>
                ...
                {quickActions.map((qa) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-2.5 w-full px-2.5 py-2.5 rounded-xl text-xs sm:text-[13px] text-left transition-colors text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 min-h-[44px] cursor-pointer bangla-text"
                    >
