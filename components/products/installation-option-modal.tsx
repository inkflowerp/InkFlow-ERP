        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline" className="text-[10px] uppercase font-mono py-0.5 px-1.5 bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-950/40 dark:text-indigo-300 dark:border-indigo-800">
                Logistics Master
              </Badge>
            </div>
        ...
        {!installation && (
          <div className="p-3 bg-indigo-50/60 dark:bg-indigo-950/20 border border-indigo-200/60 dark:border-indigo-900/40 rounded-xl space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-indigo-600 dark:text-indigo-400 font-medium">Click to fill rates</span>
            </div>
            <div className="flex flex-wrap gap-1.5">
              {COMMON_LOGISTICS_PRESETS.map((p) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg border border-indigo-200 dark:border-indigo-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 font-medium text-[11px] hover:border-indigo-500 hover:text-indigo-600 transition-all cursor-pointer flex items-center gap-1"
                >
