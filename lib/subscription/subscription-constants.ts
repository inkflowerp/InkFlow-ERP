...
export const FEATURE_METADATA: Record<FeatureCode, FeatureMeta> = {
  ...
  sms_notifications: {
    ...
    name_bn: 'এসএমএস নোটিফিকেশন',
    description: 'Transactional SMS alerts for invoices, receipts, and order updates.',
    minPlan: 'business',
    category: 'advanced',
  },
  machinery: {
    code: 'machinery',
    name: 'Machinery & Equipment Lifecycle',
    name_bn: 'যন্ত্রপাতি ও ইকুইপমেন্ট ব্যবস্থাপনা',
    description: 'Machine maintenance logs, capacity scheduling, and operator assignments.',
    minPlan: 'business',
    category: 'production',
  },
  attendance_qr: {
    code: 'attendance_qr',
    name: 'QR & Geofence Attendance',
    name_bn: 'কিউআর ও জিওফেন্স উপস্থিতি',
    description: 'Contactless QR clock-in and GPS radius verification for employees.',
    minPlan: 'business',
    category: 'management',
  },
  multi_branch: {
